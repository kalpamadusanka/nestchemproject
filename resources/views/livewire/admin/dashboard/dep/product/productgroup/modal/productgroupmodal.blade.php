            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form wire:submit.prevent="submit" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Product group name<span class="text-danger">*</span></label>
                            <input type="text"   wire:model="group_name" class="form-control @error('group_name') is-invalid @enderror" id="group_name" >
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Code <i class="ri-node-tree"></i></label>

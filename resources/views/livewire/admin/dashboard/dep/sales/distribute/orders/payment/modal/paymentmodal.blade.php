<div>
                         ...
                         <div class="card h-100">
                             ...
                             <div class="card-body">
                                 ...
                                 <div class="mb-3">
                                     ...
                                     <p class="form-control-static">{{ $order_no ?? 'N/A' }}</p>
                                 </div>
    ...
    <p class="form-control-static badge {{ $status == 1 ? 'bg-success' : 'bg-warning' }}">
                         ...
                         <div class="card">
                             ...
                             <div class="card-body">
                                 <div class="mb-3">
                                     ...
                                     <p class="form-control-static">LKR {{ number_format($total ?? 1500.00, 2) }}</p>
                                 </div>
                                 <div class="mb-3">
                         ...
                         <div class="card">
                             ...
                             <div class="card-body">
                                 <div class="mb-3">
                                     ...
                                     <p class="form-control-static">{{ $cheque_number ?? 'Not Found' }}</p>
                                 </div>
                                 <div class="mb-3">
                                     <label class="form-label">Bank Name:</label>
                                     <p class="form-control-static">{{ $bank_name ?? 'Not Found' }}</p>
                                 </div>
                                 <div class="mb-3">
                                     <label class="form-label">Cheque Date:</label>
                                     <p class="form-control-static">{{ $cheque_date ?? 'Not Found' }}</p>
                                 </div>
                          @if($checkimg)
    <div class="mb-3">
        <label class="form-label">Cheque Image:</label>
        <div>
            <img src="{{ asset('cheque/' . $checkimg) }}" alt="Cheque Image" class="img-thumbnail" style="max-height: 100px;">
        </div>
        <div class="mt-2">
            <a href="{{ asset('cheque/' . $checkimg) }}" download class="btn btn-sm btn-primary">
     ...
     <div id="receipt-content" style="display: none;">
        <div style="max-width: 400px; margin: 0 auto; padding: 20px; font-family: Arial, sans-serif;">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <div><strong>Order No:</strong> {{ $order_no ?? 'N/A' }}</div>
            </div>
            ...
            <table style="width: 100%; border-collapse: collapse; margin-bottom: 15px;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: right; padding: 5px;">{{ number_format($total ?? 0, 2) }}</td>
                    </tr>
                    <tr>

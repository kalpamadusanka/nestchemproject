<div>
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        ...
        <!-- Grid of Cards -->
        <div class="container-fluid px-0 px-md-2" style="padding-top: 2%">
            <div
                ...
                <div class="action-buttons">
                    <a href="{{ route('admin.sale.do.add.order', ['do_no' => $doNo]) }}"  class="btn btn-primary btn-sm btn-md">
                ...
                <div class="col-12">
                    <div class="card">
                        <div
                            ...
                            <h4 class="card-title mb-2 mb-md-0">Order List</h4>
                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="table-responsive">
                                            <table id="datatable"
                                                ...
                                                <thead>
                                                    <tr role="row">
                                                        <th class="sorting sorting_asc">Invoice No</th>
                                                        <th class="sorting">Order No</th>
                                                        <th class="sorting">DO No</th>
                                                        <th class="sorting">Sale represntative</th>
                                                        <th class="sorting">Customer</th>
                                                        <th class="sorting">Total Qty</th>
                                                        <th class="sorting">Total(LKR)</th>
                                                        <th class="sorting">Due amount(LKR)</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    @foreach ($salesorder as $sale)
                                                        <tr>
                                                            <td>{{ $sale->invoice_no ?? 'Not Updated' }}</td>
                                                            <td>{{ $sale->order_no ?? 'Not Updated' }}</td>
                                                            <td>
                                                                {{ $sale->do_no ?? 'Not Updated' }}
                                                            </td>
                                                            <td>
                                                                {{ $sale->addedUser->name ?? 'Not Updated' }}
                                                            </td>
                                                            <td>
                                                                {{ $sale->customerData->company_name ?? 'Not Updated' }}
                                                            </td>
                                                            <td>
                                                                {{ $sale->total_qty ?? 'Not Updated' }}
                                                            </td>
                                                            <td>{{ $sale->total ?? 'Not Updated' }}</td>
                                                             <td>{{ $sale->due ?? 'Not Updated' }}</td>
                                                            <td>{{ $sale->addedUser->name ?? 'Not Updated' }}</td>

                                                            <td class="text-right">

                                                                <a href="{{ route('admin.sale.do.order.payments', ['saleorder' => $sale->id]) }}"
                                                                class="btn btn-round btn-warning btn-icon btn-sm remove"
                                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="Payments" style="cursor: pointer;"
                                                                ><i class="fas fa-money-bill-wave"></i></a>

                                                                <a href="{{ route('admin.sale.do.order.track', ['saleorder' => $sale->id]) }}"
                                                                class="btn btn-round btn-success btn-icon btn-sm remove"
                                                                data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="Track" style="cursor: pointer;"
                                                                ><i class="fas fa-map-marker-alt"></i>

                                                            </a>
                                                                    <a href="#"
                                                                        class="btn btn-round btn-primary btn-icon btn-sm remove"
                                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="Order Items" style="cursor: pointer;"
                                                                        wire:click="orderedproduct({{ $sale->id }})"><i
        ...
        <livewire:admin.dashboard.dep.sales.distribute.orders.modal.vieworderedproductmodal />

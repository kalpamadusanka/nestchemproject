    ...
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        ...
        <div class="header d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <h4 class="me-3">Loading Management</h4>
                <nav class="nav">
                ...
                <div class="col-12">
                    <div class="card">
                        <div
                            ...
                            <h4 class="card-title mb-2 mb-md-0">Loading List</h4>
                        </div>
                                        ...
                                        <div class="col-md-4 p-2">
                                            <div class="card shelf-card h-100 border-0 shadow-sm">
                                                <div class="card-body">
                                                    ...
                                                    <div class="d-grid">
                                                        <a href="{{ route('admin.sale.do.load', ['do_no' => $do->do_no]) }}"
                                                            wire:navigate
                                                            class="btn btn-primary d-flex align-items-center justify-content-center">
                                                            <i class="bi bi-plus-circle me-2"></i>Load
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>

<div>
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        <div class="header d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <h4 class="me-3">Worksheet Management</h4>
                <nav class="nav">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center ">
                <div>
                    <h4 class="fw-bold" style="margin-bottom: 0px;">Worksheet </h4>
                ...
                <div class="action-buttons">
                    ...
                    <a href="{{ route('admin.dashboard.dep.human.resource.worksheet.holiday') }}" wire:navigate class="btn btn-primary" >
                        <i class="bi bi-plus-circle"></i> Holidays
                    </a>
                    <a href="{{ route('admin.dashboard.dep.human.resource.worksheet.workday') }}" wire:navigate class="btn btn-primary" >
                        <i class="bi bi-plus-circle"></i> Working days
                    </a>
                    <button class="btn btn-primary" wire:click="opentodaysworkmodal">
                        <i class="bi bi-plus-circle"></i> Add Today'S Work
                    </button>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <h4 class="card-title mb-0">Worksheet</h4>
                                        ...
                                        <table id="datatable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 330px;"
                                                        aria-label="Office: activate to sort column ascending">Deadline
                                                    </th>
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 330px;"
                                                        aria-label="Age: activate to sort column ascending">Worked hour</th>
                                                        <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 330px;"
                                                        aria-label="Age: activate to sort column ascending">Date</th>
                                                        <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 330px;"
                                                        aria-label="Age: activate to sort column ascending">Note</th>
                                                        <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 330px;"
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th rowspan="1" colspan="1">Worked hour</th>
                                                ...
                                                <tr>
                                                    <td colspan="3"></td>
                                                    <td><strong>Hours</strong> {{ $totalworkedhours ?? 'Not updated!' }}h</td>
                                                    <td colspan="4"></td>
                                                </tr>
                                                @endif
                                            ...
                                            <tbody>
                                               @if ($workdata)
                                                   @foreach ($workdata as $w)
                                                      <tr>
                                                           <td>{{ $w->employeeData->username }}</td>
                                                           <td>{{ $w->task }}</td>
                                                           <td>{{ \Carbon\Carbon::parse($w->deadline)->format('Y M d h.i A') }}</td>
                                                           <td>{{ $w->worked_hours }}h</td>
                                                           ...
                                                           <td class="text-right">
                                                            ...
                                                            <a
                                                                class="btn btn-round btn-warning btn-icon btn-sm edit" wire:click="editworksheetdata({{ $w->id }})"><i class="fas fa-pencil-alt"></i>
                                                            </a>
                                                            @if ($w->status==0)
                                                            <a
                                                            class="btn btn-round btn-success btn-icon btn-sm remove" wire:click="activerecord({{ $w->id }})"><i
                                                                class="fas fa-check"></i></a>
                                                            @else
                                                            <a
                                                            class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deactiveworkrecord({{ $w->id }})"><i
                                                            ...
                                                            @endif
                                                                    ...
                                                                    <a href="#"
                                                                    class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deleteworksheetdata({{ $w->id }})"><i
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-5">
                                        <div class="dataTables_info" id="datatable_info" role="status" aria-live="polite">
                                            Showing {{ $workdata->firstItem() }} to {{ $workdata->lastItem() }} of {{ $workdata->total() }} entries
                                        </div>
                                    </div>
    ...
    <livewire:admin.dashboard.dep.humanresource.worksheet.modal.addworkmodal />
    <livewire:admin.dashboard.dep.humanresource.worksheet.modal.editworkdata />
        </div>
    </div>

    ...
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center ">
                <div>
                    <h4 class="fw-bold" style="margin-bottom: 0px;">Holidays List</h4>
                ...
                <div class="action-buttons">
                    ...
                    <button class="btn btn-primary" wire:click="addholiday">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="datatable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting sorting_asc" tabindex="0"
                                                        ...
                                                        aria-label="Name: activate to sort column descending">Holiday</th>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th rowspan="1" colspan="1">Holiday</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd">
                                                   <td class="dtr-control sorting_1" tabindex="0">{{ $h->holiday ?? 'Not updated' }}</td>
                                                   <td>{{ $h->date ? \Carbon\Carbon::parse($h->date)->format('Y M d h:i A') : 'Not updated' }}</td>
                                                   <td>
                                                    @if ($h->status == 0)
                                                   ...
                                                   <td class="text-right">
                                                     @if ($h->status == 0)
                                                     <a href="#"
                                                     class="btn btn-round btn-warning btn-icon btn-sm remove" wire:click="active({{ $h->id }})"><i
                                                         class="fas fa-check"></i></a>
                                                     @else
                                                     <a href="#"
                                                     class="btn btn-round btn-warning btn-icon btn-sm remove" wire:click="deactive({{ $h->id }})"><i
                                                     ...
                                                     @endif
                                                       ...
                                                       @if (auth()->user() && auth()->user()->role == 'HR & Administration Executive' || auth()->user()->role == 'Superadmin')
                                                           ...
                                                           <a href="#"
                                                           class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deleteholiday({{ $h->id }})"><i
        ...
        <livewire:admin.dashboard.dep.humanresource.worksheet.holiday.modal.addholidaymodal/>
        </div>
    </div>

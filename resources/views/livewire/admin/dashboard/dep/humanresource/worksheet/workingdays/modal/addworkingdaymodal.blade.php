                ...
                <div class="modal-body p-4">
                    <form wire:submit.prevent="submit" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" wire:model="workday" id="workday" class="form-control @error('workday') is-invalid @enderror" placeholder="Working day" disabled>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Date<span class="text-danger">*</span></label>
                            <input type="date" wire:model="date" id="date" class="form-control @error('date') is-invalid @enderror" placeholder="Pick date">
                        </div>
                        <!-- Submit Button -->

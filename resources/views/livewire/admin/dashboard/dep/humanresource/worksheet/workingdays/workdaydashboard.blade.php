    ...
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center ">
                <div>
                    <h4 class="fw-bold" style="margin-bottom: 0px;">Working days List</h4>
                    <nav aria-label="breadcrumb" style="margin-bottom: 5px;">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Worksheet</a></li>
                ...
                <div class="action-buttons">
                    ...
                    <button class="btn btn-primary" wire:click="addworkingdays">
                        <i class="bi bi-plus-circle"></i>Add Working days
                    </button>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <h4 class="card-title mb-0">Working days</h4>
                                    ...
                                    <div class="col-sm-12">
                                        <table id="datatable"
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="odd">
                                                   <td class="dtr-control sorting_1" tabindex="0">{{ $w->workday ?? 'Not updated' }}</td>
                                                   <td>{{ $w->date ? \Carbon\Carbon::parse($w->date)->format('Y M d h:i A') : 'Not updated' }}</td>
                                                   <td>
                                                    @if ($w->status == 0)
                                                   ...
                                                   <td class="text-right">
                                                     @if ($w->status == 0)
                                                     <a href="#"
                                                     class="btn btn-round btn-warning btn-icon btn-sm remove" wire:click="active({{ $w->id }})"><i
                                                         class="fas fa-check"></i></a>
                                                     @else
                                                     <a href="#"
                                                     class="btn btn-round btn-warning btn-icon btn-sm remove" wire:click="deactive({{ $w->id }})"><i
                                                     ...
                                                     @endif
                                                       ...
                                                       @if (auth()->user() && auth()->user()->role == 'HR & Administration Executive' || auth()->user()->role == 'Superadmin')
                                                           ...
                                                           <a href="#"
                                                           class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deleteworkday({{ $w->id }})"><i
        ...
        <livewire:admin.dashboard.dep.humanresource.worksheet.workingdays.modal.addworkingdaymodal/>
        </div>
    </div>

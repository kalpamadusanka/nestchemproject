                ...
                <div class="modal-body p-4">
                    <form wire:submit.prevent="submit" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" wire:model="birthday" id="contact" class="form-control @error('contact') is-invalid @enderror" placeholder="Enter contact">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Postal Code <span class="text-danger">*</span></label>
                            <input type="text" wire:model="postalcode" id="contact" class="form-control @error('contact') is-invalid @enderror" placeholder="Enter contact">
                        </div>

<div>
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center ">
                <div>
                    ...
                    <nav aria-label="breadcrumb" style="margin-bottom: 5px;">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Assets type</li>
                        </ol>
                    </nav>
                </div>
                <div class="action-buttons">
                    ...
                    <button class="btn btn-primary" wire:click="openassetstypemodal">
                        <i class="bi bi-plus-circle"></i> Add Assets Type
                    </button>
                </div>
            </div>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <h4 class="card-title mb-0">Assets Type List</h4>
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting sorting_asc" tabindex="0"
                                                        ...
                                                        aria-label="Name: activate to sort column descending">Assets type</th>

                                                        <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 330px;"
                                                        aria-label="Age: activate to sort column ascending">Description</th>
                                                        <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 330px;"
                                                  ...
                                                  @foreach ($assetstype as $type)
                                                      <tr>
                                                        ...
                                                        <td>
                                                            @if ($type->status==0)
                                                            <a
                                                            class="btn btn-round btn-success btn-icon btn-sm remove" wire:click="activeassettype({{ $type->id }})"><i
                                                                class="fas fa-check"></i></a>
                                                            @else
                                                            <a
                                                            class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deactiveassetstype({{ $type->id }})"><i
                                                            ...
                                                            @endif
                                                                    ...
                                                                    <a href="#"
                                                                    class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deleteassetstype({{ $type->id }})"><i
        ...
        <livewire:admin.dashboard.dep.humanresource.assets.assettype.modal.assetstypemodal/>

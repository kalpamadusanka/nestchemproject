    ...
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center ">
                <div>
                    <h4 class="fw-bold" style="margin-bottom: 0px;">Collection </h4>
                ...
                <div class="action-buttons">
                    ...
                    <a  wire:navigate class="btn btn-primary" wire:click="opencollectionmodal">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <h4 class="card-title mb-0">Collection List</h4>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="datatable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting sorting_asc" tabindex="0"
                                                        ...
                                                        aria-label="Name: activate to sort column descending">Collection</th>
                                            ...
                                            <tbody>
                                               @if ($dataCollection)
                                                   @foreach ($dataCollection as $collection)
                                                       <tr>
                                                        <td>{{ $collection->collection_name }}</td>
                                                        <td>{{ $collection->description }}</td>
                                                        <td> @if ($collection->status == 1)
                                                        ...
                                                        <td class="text-right">
                                                                <a
                                                                class="btn btn-round btn-warning btn-icon btn-sm remove" wire:click="editcollection({{ $collection->id }})"><i
                                                                    class="fas fa-edit"></i></a>
                                                             @if ($collection->status==0)

                                                             <a
                                                             class="btn btn-round btn-success btn-icon btn-sm remove" wire:click="activecollection({{ $collection->id }})"><i
                                                                 class="fas fa-check"></i></a>
                                                             @else
                                                             <a
                                                             class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deactivecollection({{ $collection->id }})"><i
                                                             ...
                                                             @endif
                                                                     ...
                                                                     <a href="#"
                                                                     class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deletecollection({{ $collection->id }})"><i
...
<livewire:admin.dashboard.dep.humanresource.datacollection.collection.modal.addcollectionmodal />
        </div>
    </div>

    ...
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        <div class="header d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <h4 class="me-3">Data Collection</h4>
                <nav class="nav">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center ">
                <div>
                    <h4 class="fw-bold" style="margin-bottom: 0px;">Company </h4>
                ...
                <div class="action-buttons">
                    ...
                    <a href="{{ route('admin.dashboard.dep.human.resource.datacollection.collection') }}" wire:navigate class="btn btn-primary" >
                        <i class="bi bi-plus-circle"></i> Add Collection
                    </a>


                    <a   class="btn btn-primary" wire:click="openadddatamodal">
                                            ...
                                            <tbody>
                                               @if ($hrdata)
                                                   @foreach ($hrdata as $data)
                                                       <tr>
                                                        <td>{{ $data->name }}</td>
                                                        <td>{{ $data->dataCollection->collection_name }}</td>
                                                        <td> @if ($data->status == 1)
                                                        ...
                                                        <td class="text-right">
                                                            <a
                                                            class="btn btn-round btn-warning btn-icon btn-sm remove" wire:click="uploadfile({{ $data->id }})"><i
                                                                class="fas fa-upload"></i></a>
                                                                <a
                                                                class="btn btn-round btn-warning btn-icon btn-sm remove" wire:click="viewfiles({{ $data->id }})"><i
                                                                    class="fas fa-file"></i></a>


                                                                 @if (auth()->user()->role == 'Superadmin')
                                                                 <a href="#"
                                                                 class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deletedata({{ $data->id }})"><i
...
<livewire:admin.dashboard.dep.humanresource.datacollection.adddata.modal.adddatamodal/>
<livewire:admin.dashboard.dep.humanresource.datacollection.modal.docviewmodal/>
<livewire:admin.dashboard.dep.humanresource.datacollection.modal.uploadfilemodal/>
        </div>
    </div>

                ...
                <div class="modal-body p-4">
                    <form wire:submit.prevent="submit" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" wire:model="dataname" class="form-control @error('dataname') is-invalid @enderror" id="dataname">
                        </div>
                        ...
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <select wire:model="collection" class="form-select  @error('collection') is-invalid @enderror" id="collection">

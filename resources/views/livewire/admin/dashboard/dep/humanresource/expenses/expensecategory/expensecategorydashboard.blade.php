        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center ">
                ...
                <div class="action-buttons">
                    ...
                    <button class="btn btn-primary" wire:click="openexpensecategorymodal">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <h4 class="card-title mb-0">Expenses Category List</h4>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="datatable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 530px;"
                                            ...
                                            <tbody>
                                               @if ($expensecategory)
                                                   @foreach ($expensecategory as $expcategory)
                                                       <tr>
                                                        <td>
                                                            {{ $expcategory->category_name ?? 'Not Updated'}}
                                                        </td>
                                                        <td>
                                                            {{ $expcategory->note ?? 'Not Updated'}}
                                                        </td>
                                                        <td>
                                                            @if ($expcategory->status == 0)
                                                        ...
                                                        <td class="text-right">
                                                         ...
                                                         <a
                                                         class="btn btn-round btn-success btn-icon btn-sm remove" wire:click="activecategory({{ $expcategory->id }})"><i
                                                             class="fas fa-check"></i></a>
                                                         @else
                                                         <a
                                                         class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deactivecategory({{ $expcategory->id }})"><i
                                                         ...
                                                         @endif
                                                                 ...
                                                                 <a href="#"
                                                                 class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deletecategory({{ $expcategory->id }})"><i
          ...
          <livewire:admin.dashboard.dep.humanresource.expenses.expensecategory.modal.expensecategorymodal/>

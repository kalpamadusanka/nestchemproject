    ...
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        <div class="header d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <h4 class="me-3">Payment Methods Management</h4>
                <nav class="nav">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center ">
                ...
                <div class="action-buttons">
                    ...
                    <button class="btn btn-primary" wire:click="openpaymentmethodmodal">
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting sorting_asc" tabindex="0"
                                                        ...
                                                        aria-label="Name: activate to sort column descending">Payment method</th>
                                                   ...
                                                   @foreach ($paymentmethods as $payment)
                                                       <tr>
                                                        ...
                                                        <td class="text-right">
                                                            ...
                                                            <a
                                                            class="btn btn-round btn-success btn-icon btn-sm remove" wire:click="activepaymentmethod({{ $payment->id }})"><i
                                                                class="fas fa-check"></i></a>
                                                            @else
                                                            <a
                                                            class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deactivepaymentmethod({{ $payment->id }})"><i
                                                            ...
                                                            @endif
                                                                    ...
                                                                    <a href="#"
                                                                    class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deletepaymentmethod({{ $payment->id }})"><i
...
<livewire:admin.dashboard.dep.humanresource.expenses.paymentmethods.modal.addpaymentmethodmodal />
        </div>
    </div>

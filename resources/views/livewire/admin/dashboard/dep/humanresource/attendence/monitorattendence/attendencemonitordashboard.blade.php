<div>
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center ">
                <div>
                    <h4 class="fw-bold" style="margin-bottom: 0px;">Attendence</h4>
                ...
                <div class="action-buttons">
                    ...
                    <button class="btn btn-primary" wire:click="openattendencemodal">
                                        ...
                                        <table id="datatable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        ...
                                                        aria-label="Age: activate to sort column ascending">Hours</th>
                                            ...
                                            <tbody>
                                                @if ($attendenceData)
                                                    ...
                                                    <tr>
                                                        <td>{{ $attendence->employeeData->username }}</td>
                                                        <td>
                                                            <span class="rounded-border">{{ \Carbon\Carbon::parse($attendence->timein)->format('Y M d') }}</span>
                                                            {{ \Carbon\Carbon::parse($attendence->timein)->format('h.i A') }}
                                                        </td>

                                                        <td>
                                                            <span class="rounded-border">{{ \Carbon\Carbon::parse($attendence->timein)->format('Y M d') }}</span>
                                                            {{ \Carbon\Carbon::parse($attendence->timeout)->format('h.i A') }}
                                                        </td>
                                                        <td>{{ number_format($attendence->worked_hours, 1) }}/8h</td>
                                                        ...
                                                        <td class="text-right">
                                                         ...
                                                         <a
                                                         class="btn btn-round btn-success btn-icon btn-sm remove" wire:click="activeattendencerecord({{ $attendence->id }})"><i
                                                             class="fas fa-check"></i></a>
                                                         @else
                                                         <a
                                                         class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deactiveattendencerecord({{ $attendence->id }})"><i
                                                         ...
                                                         @endif
                                                                 ...
                                                                 <a href="#"
                                                                 class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deleteattendencedata({{ $attendence->id }})"><i
 ...
 <livewire:admin.dashboard.dep.humanresource.attendence.monitorattendence.modal.addattendencemodal/>
        </div>
    </div>

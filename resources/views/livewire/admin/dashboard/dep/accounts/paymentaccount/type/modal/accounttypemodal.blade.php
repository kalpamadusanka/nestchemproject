                ...
                <div class="modal-body p-4">
                    <form wire:submit.prevent="submit" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" wire:model="account_type" class="form-control @error('account_type') is-invalid @enderror" id="account_type">
                        </div>

    ...
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        <div class="header d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <h4 class="me-3">Account Types</h4>
                <nav class="nav">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center ">
                <div>
                    ...
                    <nav aria-label="breadcrumb" style="margin-bottom: 5px;">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Account types List</li>
                        </ol>
                    </nav>
                </div>
                <div class="action-buttons">
                    ...
                    <a wire:click="openaccountypeaddmodal" class="btn btn-primary" >
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <h4 class="card-title mb-0">Account type List</h4>
                                                ...
                                                @foreach ($accounttypedata as $accounttype)
                                                   <tr>
                                                        ...
                                                        <td class="text-right">
                                                         ...
                                                         <a
                                                         class="btn btn-round btn-success btn-icon btn-sm remove" wire:click="activerecord({{ $accounttype->id }})"><i
                                                             class="fas fa-check"></i></a>
                                                         @else
                                                         <a
                                                         class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deactiverecord({{ $accounttype->id }})"><i
                                                         ...
                                                         @endif
                                                                 ...
                                                                 <a href="#"
                                                                 class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deletedata({{ $accounttype->id }})"><i
            ...
            <livewire:admin.dashboard.dep.accounts.paymentaccount.type.modal.accounttypemodal/>
        </div>
    </div>

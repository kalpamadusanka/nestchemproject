            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-4">
                    <form wire:submit.prevent="submit" enctype="multipart/form-data">
                        ...
                        <!-- Name -->
                        <div class="mb-3">
                            <label for="delivery-date" class="form-label">Recevied Date</label>
                            <input type="date" class="form-control @error('received_date') is-invalid @enderror" id="delivery-date" wire:model="received_date">
                        </div>

    ...
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center ">
                <div>
                    <h4 class="fw-bold" style="margin-bottom: 0px;">Warehouse </h4>
                ...
                <div class="action-buttons">
                    ...
                    <a wire:click="openwarehouseaddmodal" class="btn btn-primary" >
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <h4 class="card-title mb-0">Warehouse List</h4>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="datatable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting sorting_asc" tabindex="0"
                                                        ...
                                                        aria-label="Name: activate to sort column descending">Warehouse</th>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <th rowspan="1" colspan="1">Warehouse</th>
                                                    <th rowspan="1" colspan="1">Warehouse Code</th>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($warehousedata as $warehouse)
                                                   <tr>
                                                        ...
                                                        <td class="text-right">
                                                         <a
                                                             class="btn btn-round btn-warning btn-icon btn-sm edit" wire:click="editwarehousedata({{ $warehouse->id }})"><i class="fas fa-pencil-alt"></i>
                                                         </a>
                                                                 @if (auth()->user()->role == 'Superadmin')
                                                                 <a href="#"
                                                                 class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deletewarehousedata({{ $warehouse->id }})"><i
      ...
      <livewire:admin.dashboard.dep.production.material.warehouse.modal.warehouseaddmodal/>
      <livewire:admin.dashboard.dep.production.material.warehouse.modal.warehouseeditmodal/>
        </div>
    </div>

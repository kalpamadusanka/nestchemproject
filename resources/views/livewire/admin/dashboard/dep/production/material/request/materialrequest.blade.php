<div>
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        <div class="header d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <h4 class="me-3">Requested Material</h4>
                <nav class="nav">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center ">
                <div>
                    ...
                    <nav aria-label="breadcrumb" style="margin-bottom: 5px;">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Requested</a></li>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <h4 class="card-title mb-0">Requested List</h4>
                                                    ...
                                                    <div class="d-flex gap-2">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" id="date-range"
                                                                ...
                                                                wire:model="daterange" placeholder="Select date range">
                                                        </div>
                                                        <script>
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting sorting_asc" tabindex="0"
                                                        ...
                                                        aria-label="Name: activate to sort column descending">Material
                                                        Code</th>
                                                    ...
                                                    @foreach ($requestdata as $data)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                @elseif($data->req_status == 'transferred')
                                                                    <span
                                                                        class="badge badge-success">Transferred</span>
                                                                @else
                                                            ...
                                                            <td>
                                                                @if ($data->req_status == 'pending')
                                                                    <a class="btn btn-round btn-success btn-icon btn-sm remove"
                                                                        wire:click="transferred({{ $data->id }})"><i
                                                                ...
                                                                @elseif ($data->req_status == 'transferred')
                                                                    <a
                                                                        class="btn btn-round btn-success btn-icon btn-sm "><i
                                                                            class="fas fa-check"></i></a>
                                                                @else
                                                                    <a class="btn btn-round btn-danger btn-icon btn-sm remove"
                                                                        wire:click="decline({{ $data->id }})"><i
            ...
            <livewire:admin.dashboard.dep.production.material.request.modal.requestreasonmodal />
            <livewire:admin.dashboard.dep.production.material.request.modal.materialissuemodal/>
    ...
    <script>
        window.addEventListener('uommismatch', function() {


            Swal.fire({
                icon: 'warning',
                title: 'Warning!',
                text: 'The unit of measurement does not match. Please verify and try again!',
        ...
        window.addEventListener('insufficientstock', function() {


            Swal.fire({
                icon: 'warning',
                title: 'Warning!',
                text: 'Insufficient stock available for this item. Please restock or adjust the quantity.!',
                showConfirmButton: false,
                timer: 5000,
                toast: true,
                position: 'top-end'
        ...
        window.addEventListener('stocknotfound', function() {


            Swal.fire({
                icon: 'warning',
                title: 'Warning!',
                text: 'The requested stock is unavailable. Please check inventory or update stock records.',
                showConfirmButton: false,
                timer: 5000,
                toast: true,
                position: 'top-end'
        ...
        window.addEventListener('materialIssuedconfirmed', function() {
            Swal.fire({
                icon: 'success',
                title: 'Success!',
                text: 'The material has been issued successfully.',
                showConfirmButton: false,
                timer: 3000,
                toast: true,
                position: 'top-end'

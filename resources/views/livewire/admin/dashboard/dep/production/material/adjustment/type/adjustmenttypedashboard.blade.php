    ...
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        <div class="header d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <h4 class="me-3">Inventory Adjustment type</h4>
                <nav class="nav">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center ">
                <div>
                    <h4 class="fw-bold" style="margin-bottom: 0px;">Adjustment </h4>
                    <nav aria-label="breadcrumb" style="margin-bottom: 5px;">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Type</a></li>
                            <li class="breadcrumb-item active" aria-current="page">All Adjustment type</li>
                        </ol>
                    </nav>
                </div>
                <div class="action-buttons">

                    <a wire:click="openadjustmenttypemodal" class="btn btn-primary">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <h4 class="card-title mb-0">Adjustment type list</h4>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="datatable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting sorting_asc" tabindex="0"
                                                        ...
                                                        aria-label="Name: activate to sort column descending">Adjustment type
                                                    </th>
                                            ...
                                            <tbody>
                                                @if ($adjustmenttypes)
                                                @foreach ($adjustmenttypes as $adjustment)
                                                    <tr>
                                                        <td>{{ $adjustment->adjustment_type }}</td>
                                                        <td>{{ $adjustment->description ?? 'Not Updated'}}</td>
                                                        <td>
                                                            @if ($adjustment->type == 'increase')
                                                            <span class="badge badge-primary">Increase</span>
                                                            @else
                                                            <span class="badge badge-primary">Decrease</span>
                                                            @endif
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td class="text-right">
                                                            ...
                                                            @if (auth()->user()->role == 'Superadmin')
                                                                <a href="#"
                                                                    ...
                                                                    wire:click="deletedata({{ $adjustment->id }})"><i
            ...
            <livewire:admin.dashboard.dep.production.material.adjustment.type.modal.addadjustmenttypemodal />

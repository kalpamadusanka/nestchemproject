    ...
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        <div class="header d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <h4 class="me-3">Material Categories</h4>
                <nav class="nav">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center ">
                ...
                <div class="action-buttons">
                    ...
                    <a wire:click="addmaterialcategory" class="btn btn-primary" >
                        <i class="bi bi-plus-circle"></i> Add Material Category
                    </a>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            ...
                            <h4 class="card-title mb-0">Material Category</h4>
                                    ...
                                    <div class="col-sm-12">
                                        <table id="datatable"
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($materialcategoryData as $mcategory)
                                                   <tr>
                                                        <td>{{ $mcategory->category_name }}</td>
                                                        <td>{{  $mcategory->category_code }}</td>
                                                        <td>{{  $mcategory->value }}</td>
                                                        <td>
                                                        ...
                                                        <td class="text-right">
                                                         <a
                                                             class="btn btn-round btn-warning btn-icon btn-sm edit" wire:click="editmaterialcategory({{ $mcategory->id }})"><i class="fas fa-pencil-alt"></i>
                                                         </a>
                                                                 @if (auth()->user()->role == 'Superadmin')
                                                                 <a href="#"
                                                                 class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deletematerialcategory({{ $mcategory->id }})"><i
      ...
      <livewire:admin.dashboard.dep.production.material.category.modal.materialcategorymodal/>
      <livewire:admin.dashboard.dep.production.material.category.modal.editcategorymodal/>
        </div>
    </div>

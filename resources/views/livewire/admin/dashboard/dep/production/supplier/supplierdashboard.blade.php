    ...
    <div class="main-panel ps ps--active-y p-2" id="main-panel">
        <div class="header d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                ...
                <h4 class="me-3">Supplier Management</h4>
                <nav class="nav">
        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center ">
                <div>
                    <h4 class="fw-bold" style="margin-bottom: 0px;">Supplier </h4>
                ...
                <div class="action-buttons">
                    ...
                    <a wire:click="supplieraddmodal" class="btn btn-primary" >
                                        ...
                                        <table id="datatable"
                                            ...
                                            <thead>
                                                <tr role="row">
                                                    <th class="sorting sorting_asc" tabindex="0"
                                                        ...
                                                        aria-label="Name: activate to sort column descending">Supplier</th>
                                                    ...
                                                    <th class="sorting" tabindex="0" aria-controls="datatable"
                                                        rowspan="1" colspan="1" style="width: 330px;"
                                                        aria-label="Office: activate to sort column ascending">Supplier Code
                                                    </th>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th rowspan="1" colspan="1">Supplier Code</th>
                                            ...
                                            <tbody>
                                                ...
                                                @foreach ($supplierdata as $sup)
                                                   <tr>
                                                        ...
                                                        <td class="text-right">
                                                         <a
                                                             class="btn btn-round btn-warning btn-icon btn-sm edit" wire:click="editsupplierdata({{ $sup->id }})"><i class="fas fa-pencil-alt"></i>
                                                         </a>
                                                                 @if (auth()->user()->role == 'Superadmin')
                                                                 <a href="#"
                                                                 class="btn btn-round btn-danger btn-icon btn-sm remove" wire:click="deletesupplierdata({{ $sup->id }})"><i
      ...
      <livewire:admin.dashboard.dep.production.supplier.modal.addsuppliermodal/>
      <livewire:admin.dashboard.dep.production.supplier.modal.editsuppliermodal/>
